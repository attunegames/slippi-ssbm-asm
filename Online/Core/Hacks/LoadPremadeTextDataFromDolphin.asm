...
#   FIT     - without it the string renders far larger than Melee's own
#             descriptions and overflows the box
#   SCALE   - to 70%, which is what matches their size: measured, ours came out
#             709x49 against their 594x42
#   CENTER, KERN - the other descriptions are centred and tightly spaced
.byte 0x18, 0x0A, 0x00, 0x46, 0x00, 0x46, 0x10, 0x16, 0x20, 0x19, 0x20, 0x38, 0x20, 0x25, 0x20, 0x2F, 0x20, 0x2C
