...
#
# Sizing this was not obvious. Without FIT the string renders far larger than
# Melee's own descriptions and overflows the box. With FIT it fits, but FIT
# clamps to the box width and overrides SCALE entirely, so SCALE cannot make it
# smaller - tried, no effect. What does work: FIT scales the whole content,
# padding included, so symmetric spaces shrink the visible glyphs. Measured -
# unpadded FIT gives 715px of glyphs against Melee's own 594px, and five spaces
# a side lands on theirs.
.byte 0x0A, 0x00, 0x02, 0x00, 0x02, 0x10, 0x16, 0x20, 0x19, 0x20, 0x38
