...
blrl
# "Public & Private Rooms". FIT first: without it the string renders about 40%
# larger than Melee's own descriptions and overflows the box. Not kerned, which
# is how the other descriptions look.
.byte 0x18, 0x10, 0x20, 0x19, 0x20, 0x38, 0x20, 0x25, 0x20, 0x2F, 0x20, 0x2C
