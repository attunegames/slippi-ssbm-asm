...
.string "Teams"
.set TPO_STRING_PARTY, TPO_STRING_TEAMS + 6
.string "Party"
.set TPO_STRING_MODE_FORMAT, TPO_STRING_PARTY + 6
.string "%s Mode"
...
.short 0x817C # －
.byte 0x00
# Peppy: appended last so every offset above is untouched.
.set TPO_STRING_ROOMS, TPO_STRING_SPINNER_DONE + 3
.string "Rooms"
...
UPDATE_HEADER_PARTY:
addi r6, REG_TEXT_PROPERTIES, TPO_STRING_PARTY
b UPDATE_HEADER
...
beq UPDATE_WAITING
cmpwi r11, ONLINE_MODE_ROOMS
beq UPDATE_WAITING
cmpwi r11, ONLINE_MODE_RANKED
beq UPDATE_WAITING
cmpwi r11, ONLINE_MODE_PARTY
beq UPDATE_WAITING
